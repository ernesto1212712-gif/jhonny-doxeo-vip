...
export const getAIResponse = async (history: Message[], prompt: string) => {
  try {
    // Inicializamos dentro de la función para asegurar que use la variable de entorno de Vercel más reciente
    ...
    return "El sistema está saturado. Por favor, contacta a Jhonny directamente por WhatsApp.";
  }
};